...
//		savedInstanceState.putInt("Score", GameLayer.score);	
...
//		GameLayer.score= savedInstanceState.getInt("Score");
	...
	public void onStart() {
		...
		try {
			scene.addChild((CCLayer) GameLayer.class.newInstance());
